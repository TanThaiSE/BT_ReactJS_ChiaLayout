...
import IpX from '../assets/img/sp_iphoneX.png';
import Note7 from '../assets/img/sp_note7.png';
import Vivo from '../assets/img/sp_vivo850.png';
import Black from '../assets/img/sp_blackberry.png';
        ...
        return (
            <div className="row">
                ...
                <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-lg-3">
                    <div className="container">
                        <div className="card bg-light" style={{ width: 300 }}>
                            <img className="card-img-top" src={IpX} alt="Card image" style={{ maxWidth: '100%', height: 250 }} />
                ...
                <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-lg-3">
                    <div className="container">
                        <div className="card bg-light" style={{ width: 300 }}>
                            <img className="card-img-top" src={Vivo} alt="Card image" style={{ maxWidth: '100%', height: 250 }} />
                            <div className="card-body text-center">
                ...
                <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-lg-3">
                    <div className="container">
                        <div className="card bg-light" style={{ width: 300 }}>
                            <img className="card-img-top" src={Black} alt="Card image" style={{ maxWidth: '100%', height: 250 }} />
                            <div className="card-body text-center">
